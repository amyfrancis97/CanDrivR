...
outputDir=/bp1/mrcieu1/data/encode/public/CanDrivR/training/${1}/features/

# Load the positive and negative datasets
variants=/bp1/mrcieu1/data/encode/public/CanDrivR/training/${1}/cosmicGnomadVariantsReformatted_${1}.bed
